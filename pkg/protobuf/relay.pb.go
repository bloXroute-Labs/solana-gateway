...
const file_relay_proto_rawDesc = "" +
	"\n" +
	"\vrelay.proto\x12\x05relay\"\xaa\x01\n" +
	...
	"serverPort\x123\n" +
	"\x15gateway_configuration\x18\x04 \x01(\fR\x14gatewayConfiguration\"3\n" +
	"\x10RegisterResponse\x12\x1f\n" +
	"\vudp_address\x18\x01 \x01(\tR\n" +
	"udpAddress2D\n" +
	"\x05Relay\x12;\n" +
	"\bRegister\x12\x16.relay.RegisterRequest\x1a\x17.relay.RegisterResponseB7Z5github.com/bloXroute-Labs/solana-gateway/pkg/protobufb\x06proto3"
